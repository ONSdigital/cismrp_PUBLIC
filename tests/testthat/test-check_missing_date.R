...
output <- check_missing_date(
  dummy_data, "Scotland",
  as.Date("27apr2020", format = "%d%b%Y"),
  "27apr2020"
)

# Function silently identifies No missing dates
testthat::test_that("Function silently identifies no missing dates", {
  testthat::expect_silent(check_missing_date
  (
    dummy_data, "Scotland",
    as.Date("27apr2020", format = "%d%b%Y"),
    "27apr2020"
...
# test error produced if missing dates
...
testthat::test_that("Function returns error confirming  missing dates", {
  testthat::expect_error(check_missing_date
  (
    dummy_data, "Scotland",
    as.Date("27apr2020", format = "%d%b%Y"),
    "27apr2020"
