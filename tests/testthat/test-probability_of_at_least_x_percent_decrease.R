...
testthat::test_that(
  ...
  code = {
    ...
    expected_col_classes <- c(rep("numeric", 9))
  ...
  code = {
    testthat::expect_true(
      all(colnames(test_data) == c(
        ...
        "prob_min_15_percent_increase_week_minus_1",
        "prob_min_15_percent_increase_week_minus_2",
        "prob_min_15_percent_decrease_week_minus_1",
        "prob_min_15_percent_decrease_week_minus_2"
      ))
    )
  }
)
