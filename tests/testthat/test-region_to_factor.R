...
output <- region_to_factor(output)
...
# Function returns region with correct levels and as a factor
...
# Test function returns region as a factor
testthat::test_that("function returns region as a factor", {
  expect_true(is.factor(output$region))
})
