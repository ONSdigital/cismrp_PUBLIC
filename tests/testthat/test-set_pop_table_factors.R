...
# expected_age_groups <- factor(c('2-11', '12-16', '17-24', '25-34', '35-49', '50-69', '70+', '2-11', '17-24', '25-34', '35-49', '50-69', '2-11', '12-16', '17-24'), levels = c('2-11', '12-16', '17-24', '25-34', '35-49', '50-69', '70+'))
# actual_age_groups <- output %>% dplyr::pull(age_group)
# expected_age_groups
# actual_age_groups

# testthat::test_that("age_groups, levels and type are correct", {
# expect_equal(actual_age_groups, expected_age_groups) })

# Function returns new clean region names with correct levels and as a factor
expected_region_names <- factor(c(
  "North East", "North West",
  "Yorkshire and The Humber", "East Midlands",
  "West Midlands", "East of England", "London",
  "South East", "South West", "North East",
  "North East", "North East", "Wales",
  "Scotland", "Northern Ireland"
))

actual_region_names <- factor(output %>% dplyr::pull(region))
...
col_names <- c("gor_code", "sex", "age_group", "region", "N")
